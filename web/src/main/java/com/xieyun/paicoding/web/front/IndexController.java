package com.xieyun.paicoding.web.front;

import com.xieyun.paicoding.core.util.MapUtils;
...
public class IndexController {
    ...
    private List<Map<String, Object>> categories(String active) {
        ...
        for (int i = 0; i < DEFAULT_CATEGORIES.size(); i++) {
            list.add(MapUtils.create("name", DEFAULT_CATEGORIES.get(i), "selected",
                    hit && DEFAULT_CATEGORIES.get(i).equals(active), "refCount", i + 1));
        }
        return list;
    }
