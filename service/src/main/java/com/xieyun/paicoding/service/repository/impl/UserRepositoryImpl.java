...
import com.xieyun.paicoding.core.common.enums.*;
import com.xieyun.paicoding.service.repository.UserRepository;
...
import com.xieyun.paicoding.service.repository.mapper.UserFootMapper;
import com.xieyun.paicoding.service.repository.mapper.UserInfoMapper;
import com.xieyun.paicoding.service.repository.mapper.UserMapper;
import com.xieyun.paicoding.service.repository.mapper.UserRelationMapper;
...
public class UserRepositoryImpl implements UserRepository {
    ...
    @Override
    public Integer queryCollectionCount(Long documentId) {
        LambdaQueryWrapper<UserFootDTO> query = Wrappers.lambdaQuery();
        query.eq(UserFootDTO::getDocumentId, documentId)
